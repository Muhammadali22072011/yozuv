...
def get_bookings_for_date(
    ...
    # When a specific master is chosen, only THAT master's bookings block the
    # slot — another master can run a parallel session at the same time.
...
def get_available_slots(
    ...
    existing_bookings = get_bookings_for_date(db, business_id, d, staff_id=staff_id)
